...
class Updatepage extends JFrame implements ActionListener{
    private Container c;
    ...
    public Updatepage()
    {
        ...
        c.setLayout(null);
         ...
         b1 = new JButton("Update the table");
		 b1.setSize(200,20); 
        ...
        try{
            ...
            if(e.getSource() == b1){
                try{
                    ...
                    String sql1 = "Update animals set aname='" + q1 + "',atype='" + q2 +"' where aid="+jml;
                    st.executeUpdate(sql1);

                    String sql2="Update features set fname='"+q3+"',fdes='"+q4+"' where aid="+jml;                  
                    st.executeUpdate(sql2);

                    String sql3="Update has set hid='"+jml+"',aname='"+q1+"',fname='"+q3+"',fdes='"+q4+"' where hid="+jml;                  
                    ...
                    t4.setText(" ");
                    t5.setText(" ");
                    resultText.setText("Row updated Successfully");
                    con.close();
                    st.close();
                }
                catch(Exception exp)
